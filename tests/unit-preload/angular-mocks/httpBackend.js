...
if( angular.module('edgefolio.common-components') ) {
  angular.module('edgefolio.common-components').requires.push('ngMock'); // Allow url redefinitions with $httpBackend.get()
}
